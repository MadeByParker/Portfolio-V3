...
const Projects = () => {
  return (
    <div id="projectsComponent" name='work' className='w-full md:h-screen text-[#694b63]'>
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
        <div className='pb-8'>
          <p id="title"className='text-4xl font-bold inline border-b-4 border-black'>
            My Projects
          </p>
          <p className='py-6 font-semibold text-lg sm:text-2xl'> Check out some of my recent projects</p>
        </div>
